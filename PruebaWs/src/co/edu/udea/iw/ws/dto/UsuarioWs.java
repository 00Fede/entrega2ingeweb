...
public class UsuarioWs {
	...
	/**
	 * Constructor necesario para mostrar informacion de usuario administrador en la lista de
	 * peticion de acceso
	 * @param cedula
	 * @param nombre
	 * @param apellido
	 * @param email
	 */
	public UsuarioWs(int cedula, String nombre, String apellido, String email){
		this.cedula = cedula;
		this.nombre = nombre;
		this.apellido = apellido;
		this.email = email;
